...
describe('Blockchain', () => {
        ...
        describe('when the chain does not start with the genesis block', () => {
            ...
            describe('when the chain starts with  the genesis block and has multiple blocks', () => {
                ...
                beforeEach(() => {
                    ...
                    blockchain.addBlock({ data: 'Battles Galatica' });
                });
                ...
                describe('and the chain contains a block with a jumped difference', () => {
                    it('return false', () => {
    ...
    describe('replaceChain()', () => {
        ...
        beforeEach(() => {
         ...
         describe('when the new chain is loner', () => {
             beforeEach(() => {
             ...
             describe('and the `validateTransactions` is true', () => {
